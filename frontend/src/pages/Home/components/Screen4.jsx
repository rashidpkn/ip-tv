    ...
    return (
        <div className='flex flex-col md:flex-row h-full w-full'>
            <div data-aos="fade-right" data-aos-duration="2000" className='w-full md:w-3/4 relative group overflow-hidden'>
                <div className="img w-full h-full bg-black/50 relative">
                    <img  src="/image/home/sports-remote.webp" className='absolute -z-10 w-full h-full object-cover group-hover:scale-110 duration-500 ' alt="" />
                </div>
